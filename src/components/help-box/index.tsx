...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Nutritionist'];
  const customerRoles: string[] = ['End User'];
  const tenantRoles: string[] = ['Nutritionist'];
  const addOns: string[] = [];
  const applicationName = `MariNutri`;
  const tenantName = `Empresa`;
